...
<div class="flex flex-col gap-60 py-28">
  <section class="centered-layout gap-10">
    <div>
      <span class="badge preset-filled-surface-200-800 text-surface-950-5">
        <IconZap size="12" />
        For Your Hands-On Discovery of Quantum Phenomena
      </span>
    </div>
    <div class="grid grid-cols-1 items-center gap-10 md:grid-cols-[2fr_1fr] md:gap-36">
      <img
    ...
    <div class="grid grid-cols-1 items-center">
      <div class="px-8 text-xl">
        <p>
          ...
          anywhere on this sphere, meaning it can be a mix of both 0 and 1 at the same time. Since a
          qubit can be anywhere on the surface of the sphere, it can hold much more information in a
          fuzzy, in-between way.
        </p>
      </div>
    </div>
    <div>
